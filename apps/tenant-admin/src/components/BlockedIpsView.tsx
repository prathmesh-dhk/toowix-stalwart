          ...
          <div className="p-3.5 border-b border-slate-100 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="relative flex-1 max-w-sm w-full">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-2 sm:py-1.5 bg-white border border-slate-200 rounded-md text-base sm:text-xs text-slate-800 focus:outline-hidden focus:ring-1 focus:ring-rose-500 focus:border-rose-500 font-mono"
              />
            </div>
          ...
          {loadingList ? (
            ...
            <div className="p-12 text-center text-slate-400 flex flex-col items-center gap-3">
              ...
              {!tableSearch && (
                <button
                  onClick={() => setShowAddModal(true)}
                  className="mt-1 px-3.5 py-2 min-h-[44px] bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 rounded-lg text-xs font-semibold transition-colors cursor-pointer inline-flex items-center gap-1.5"
                >
                  <Plus size={15} />
              ...
              <div className="md:hidden p-3 space-y-3">
                {filteredList.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="p-4 rounded-xl border border-slate-200 bg-white hover:border-rose-300 shadow-xs transition-all space-y-3"
                    >
                      <div className="flex items-start justify-between gap-2.5">
                        ...
                        <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-rose-50 text-rose-800 border border-rose-200/60 shrink-0">
                          <ShieldAlert size={12} className="text-rose-600 shrink-0" />
                          <span>{item.reason || 'Blocked'}</span>
                        </span>
                      </div>
