  ...
  return (
    <div className="font-sans antialiased text-slate-800 bg-slate-50 min-h-screen relative overflow-x-hidden flex flex-col justify-between selection:bg-blue-100 selection:text-blue-700">
      ...
      <header className="relative z-10 w-full px-8 py-6 lg:px-14 flex items-center justify-between" data-purpose="top-navigation">
        <a className="flex items-center gap-2.5 group outline-none cursor-pointer" href="/" title="Toowix Super Admin">
      ...
      <main className="relative z-10 flex-grow flex items-center justify-center px-6 py-8">
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          {/* Left Hero Showcase */}
          <section aria-label="System Identity" className="lg:col-span-6 flex flex-col justify-center items-center lg:items-start pl-0 lg:pl-6">
            {/* System Status Indicators */}
            <div className="space-y-2.5 max-w-sm mb-12 select-none" data-purpose="system-status-preview">
            ...
            {/* Platform Identity Graphic Badge */}
            <div className="relative flex flex-col items-start select-none" data-purpose="brand-emblem-cluster">
              ...
              <span className="text-[11px] font-bold text-slate-400 tracking-[0.4em] uppercase mb-0.5">PLATFORM</span>
          ...
          <section aria-label="Sign In Panel" className="lg:col-span-6 flex justify-center lg:justify-end">
            <div className="frosted-panel rounded-3xl p-8 sm:p-10 w-full max-w-[460px] border border-white/80 transition-all duration-300" data-purpose="login-modal-card">
              ...
              {!tempToken ? (
                /* ==================================================== */
                /* SCREEN 1: Super Admin Cloud Login - Ethereal Fluid   */
                /* ==================================================== */
                <>
                  <div className="mb-6">
                    <h2 className="text-2xl font-bold text-slate-900 tracking-tight" id="loginHeading">Super Admin sign in</h2>
                    <p className="text-xs sm:text-sm text-slate-500 mt-1">Enter your credentials to access the console.</p>
                  </div>

                  <form className="space-y-4" data-purpose="admin-login-form" onSubmit={handleCredentialsSubmit}>
                    {/* Primary Credential Input */}
                    <div className="space-y-1.5">
                      <label className="text-xs font-medium text-slate-600" htmlFor="adminCredential">
                        Email
                      </label>
                ...
                /* ========================================================================= */
                /* SCREEN 2: Super Admin Console - Step 2 Two-Factor Verification            */
                /* ========================================================================= */
                <>
                  {/* Security Badge & Title Header */}
                    ...
                    >
                      ...
                      <div className="flex-grow min-w-0 pr-6">
                        <div className="flex items-center gap-2 mb-0.5">
                          <span className="text-xs font-bold text-slate-900">Authenticator app (TOTP)</span>
                      ...
                      >
                        ...
                        <div className="flex-grow min-w-0 pr-6">
                          ...
                          <p className="text-xs text-slate-500 leading-relaxed">
                            Send a 6-digit verification code to your recovery email ({maskedRecoveryEmail || 'configured recovery address'}).
                          </p>
                        </div>
                  ...
                  <form className="space-y-4" onSubmit={handle2FaSubmit}>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        <label className="text-xs font-semibold text-slate-700">
                          {twoFactorMethod === 'totp' ? '6-digit authenticator code' : '6-digit verification code'}
                        </label>
                        {twoFactorMethod === 'totp' ? (
                          <span className="text-[11px] text-slate-400">
                            Updates in <strong className="text-blue-600 font-mono">30s</strong>
                          </span>
                        ) : (
                          <button
                            type="button"
                          ...
                          >
                            {sendingEmailOtp ? 'Sending...' : emailOtpCooldown > 0 ? `Resend (${emailOtpCooldown}s)` : 'Send verification code'}
                          </button>
                        )}
                      </div>
                        ...
                        <p className="text-xs text-slate-500 flex items-center gap-1.5">
                          ...
                          <span>
                            {twoFactorMethod === 'totp'
                              ...
                              : `Check ${maskedRecoveryEmail || 'your recovery email'} for the code.`}
                          </span>
                        </p>
                      </div>
                    </div>
                    ...
                    {/* Back to sign-in and security guarantee */}
